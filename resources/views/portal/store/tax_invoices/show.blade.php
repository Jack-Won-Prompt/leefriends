...
<div class="flex items-center justify-between mb-5 print:hidden">
    <a href="{{ route('portal.store.tax_invoices.index') }}" class="inline-flex items-center gap-1.5 text-sm font-bold text-neutral-500 hover:text-mango-600">← 세금계산서 목록</a>
...
<div class="max-w-3xl">
    @include('portal.partials.tax-invoice-document', ['invoice' => $invoice])
</div>
@endsection
