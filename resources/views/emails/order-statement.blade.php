    ...
    <div style="max-width:560px; margin:0 auto; padding:24px;">
        <div style="background:#fff; border-radius:16px; overflow:hidden; border:1px solid #eee;">
            ...
            <div style="padding:24px;">
                ...
                @php $tax = \App\Support\TaxSummary::fromOrder($order->loadMissing('items.supplyProduct')); @endphp
                <table style="width:100%; border-collapse:collapse; font-size:14px;">
                    ...
                    @endif
                    <tr style="border-top:1px solid #eee;"><td style="padding:10px 0; color:#444; font-weight:700;">발주 합계 (부가세 포함)</td><td style="padding:10px 0; text-align:right; font-weight:800; color:#D45A1F; font-size:18px;">{{ number_format($order->order_total) }}원</td></tr>
                </table>
            </div>
        </div>
