...
class BenchmarkService
{
    ...
    {
        $regionQuery = DB::connection('market')->table('regions')->where($column, $value);
    ...
    {
        return (float) DB::connection('market')->table($table)
    ...
    {
        return (float) DB::connection('market')->table('floating_populations')
            ->whereIn('region_code', $codes)
            ->where($period->filterColumn(), $period->code)
