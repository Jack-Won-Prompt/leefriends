...
/** 본사 포털 — 홈페이지 메뉴 관리 (관리자 메뉴관리와 동일 로직) */
class MenuController extends Controller
{
    public function index()
    {
        ...
        return view('portal.hq.menus.index', compact('menus'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('portal.hq.menus.index')->with('success', '메뉴가 등록되었습니다.');
    }
    ...
    public function update(Request $request, Menu $menu)
    {
        ...
        return redirect()->route('portal.hq.menus.index')->with('success', '메뉴가 수정되었습니다.');
    }
