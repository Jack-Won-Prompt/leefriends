...
namespace App\Http\Controllers\Admin\Market\Api;

use App\Http\Controllers\Controller;
use App\Market\Models\Analysis;
use App\Market\Models\Region;
use App\Market\Services\Analysis\MarketAnalyzer;
 ...
 */
class MarketPreviewController extends \App\Http\Controllers\Controller
{
    ...
    private function datasetsForSido(string $sidoName): array
    {
        ...
        foreach (self::DATASETS as $label => $table) {
            if (DB::connection('market')->table($table)->whereIn('region_code', $codes)->exists()) {
                $found[] = $label;
            }
        }
