...
return [
    ...
    */
    /*
    | 상권 보고서에서 한 번에 그릴 수 있는 최대 면적 (m²)
    |
    | 30km² 는 반경 약 3.1km 짜리 원이다. 반경 분석(/map)이 3km 까지 다루므로
    | 두 화면이 같은 범위를 감당하도록 맞췄다.
    */
    'max_district_area_m2' => (int) env('MAP_MAX_DISTRICT_AREA_M2', 30_000_000),
